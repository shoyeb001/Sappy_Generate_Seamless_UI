...
from app.features.generation.ai.llm import get_llm
from app.core.config import get_settings
from app.core.logging import get_logger
from app.features.generation.ai.prompts import (
    CLASSIFY_PROMPT,
...
async def generate_screen_html(state: ScreenGenerationState) -> GenerationState:
    ...
    try:
        ...
        logger.error("Error generating screen HTML for %s: %s", screen.id, exc)
        return {
