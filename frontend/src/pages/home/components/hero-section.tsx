...
export const HeroSection = () => (
  <section className="flex flex-col items-center justify-center text-center pt-24 pb-16 px-4">
    ...
    {/* Prompt Input Area */}
    <div className="w-full max-w-3xl bg-slate-900/50 border border-slate-700/50 rounded-2xl p-2 flex items-center shadow-[0_0_30px_-5px_rgba(34,211,238,0.15)] backdrop-blur-sm">
      ...
      />
      <Button className="rounded-xl px-6 font-semibold shadow-cyan-500/25">
    ...
    <div className="flex items-center gap-3 mt-6 text-sm">
      ...
      <button className="bg-slate-800/50 hover:bg-slate-800 text-slate-300 px-3 py-1 rounded-full transition-colors border border-slate-700/50">
        "A crypto dashboard with dark mode accents"
      </button>
      <button className="bg-slate-800/50 hover:bg-slate-800 text-slate-300 px-3 py-1 rounded-full transition-colors border border-slate-700/50 hidden sm:block">
